      ...
      <div class="card-body">
        ...
        <el-form ref="form"
          ...
          <el-form-item label="认证类型">
            <el-select v-model="formData.verifyType"
                       placeholder="请选择认证类型">
              <!-- <el-option label="请选择认证类型" value="0"></el-option> -->
              <el-option label="申请修改资料"
                         value="0"></el-option>
              <el-option label="认证为ACM集训队员"
                         value="1"></el-option>
              <el-option label="申请ACM退役"
                         value="2"></el-option>
              <el-option label="认证为中世竞创协会成员"
                         value="3"></el-option>
              <el-option label="认证为FJUT在校学生"
                         value="4"></el-option>
              <el-option label="认证为其他学校学生"
                         value="5"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="认证材料">
            <el-upload ref="uploadPic"
              ...
              <el-button size="mini"
                         type="primary">选择照片</el-button>
              <div slot="tip">请上传餐卡或者学生证照片（仅支持JPG,PNG格式）</div>
            </el-upload>
          </el-form-item>
          <el-form-item>
            <el-button type="primary"
                       @click="onSubmit">申请认证</el-button>
